...
(SELECT TRUNC(T1.FECHA, 'HH24')                                                                   FECHA,
  ...
  FROM (SELECT T1.FECHA,
        ...
        FROM CISCO_GGSN_EPDG_SCH1_RAW_VW@SMART2.WORLD T1,
             CISCO_GGSN_EPDG_SCH3_RAW_VW@SMART2.WORLD T2,
             CISCO_GGSN_EPDG_SCH4_RAW_VW@SMART2.WORLD T3,
             CISCO_GGSN_EPDG_SCH7_RAW_VW@SMART2.WORLD T4
       WHERE T1.FECHA = T2.FECHA
         ...
         AND T1.FECHA BETWEEN TO_DATE(FECHA_DESDE, 'DD.MM.YYYY HH24')
                          AND TO_DATE(FECHA_HASTA, 'DD.MM.YYYY HH24')+1/24
         ) T1
 ...
 SELECT TRUNC(C.FECHA, 'HH24')                                                                    FECHA,
  ...
  FROM (
     SELECT T1.FECHA,
        ...
        FROM CISCO_GGSN_SAMOG_SCH1_RAW_VW@SMART2.WORLD T1,
             CISCO_GGSN_SAMOG_SCH3_RAW_VW@SMART2.WORLD T2
     ...
     WHERE C.FECHA BETWEEN TO_DATE(FECHA_DESDE, 'DD.MM.YYYY HH24')
                       AND TO_DATE(FECHA_HASTA, 'DD.MM.YYYY HH24')
...
BEGIN
  G_PARTITION_MGMT.P_TRUNCATE_PARTITION_HOUR('CISCO_GGSN_EPDG_HOUR',P_FECHA_DESDE, P_FECHA_HASTA);
  P_CISCO_GGSN_EPDG_HOUR(P_FECHA_DESDE, P_FECHA_HASTA);
  --LANZA NIVEL DAY
...
BEGIN
  G_PARTITION_MGMT.P_TRUNCATE_PARTITION_DAY('CISCO_GGSN_EPDG_DAY',P_FECHA_DESDE, P_FECHA_HASTA);
  P_CISCO_GGSN_EPDG_DAY(P_FECHA_DESDE, P_FECHA_HASTA);
END;
...
BEGIN
  G_PARTITION_MGMT.P_TRUNCATE_PARTITION_DAY('CISCO_GGSN_EPDG_BH',P_FECHA_DESDE, P_FECHA_HASTA);
  P_CISCO_GGSN_EPDG_BH(P_FECHA_DESDE, P_FECHA_HASTA);
END;
...
BEGIN
  ...
  G_PARTITION_MGMT.P_TRUNCATE_PARTITION_DAY('CISCO_GGSN_EPDG_ISABHW',P_FECHA_DESDE, P_FECHA_HASTA);
  P_CISCO_GGSN_EPDG_ISABHW(P_FECHA_DESDE, P_FECHA_HASTA);
...
BEGIN
  G_PARTITION_MGMT.P_TRUNCATE_PARTITION_HOUR('CISCO_GGSN_SAMOG_HOUR',P_FECHA_DESDE, P_FECHA_HASTA);
  P_CISCO_GGSN_SAMOG_HOUR(P_FECHA_DESDE, P_FECHA_HASTA);
  --LANZA NIVEL DAY
...
BEGIN
  G_PARTITION_MGMT.P_TRUNCATE_PARTITION_DAY('CISCO_GGSN_SAMOG_DAY',P_FECHA_DESDE, P_FECHA_HASTA);
  P_CISCO_GGSN_SAMOG_DAY(P_FECHA_DESDE, P_FECHA_HASTA);
END;
...
BEGIN
  G_PARTITION_MGMT.P_TRUNCATE_PARTITION_DAY('CISCO_GGSN_SAMOG_BH',P_FECHA_DESDE, P_FECHA_HASTA);
  P_CISCO_GGSN_SAMOG_BH(P_FECHA_DESDE, P_FECHA_HASTA);
END;
...
BEGIN
  ...
  G_PARTITION_MGMT.P_TRUNCATE_PARTITION_DAY('CISCO_GGSN_SAMOG_ISABHW',P_FECHA_DESDE, P_FECHA_HASTA);
  P_CISCO_GGSN_SAMOG_ISABHW(P_FECHA_DESDE, P_FECHA_HASTA);
