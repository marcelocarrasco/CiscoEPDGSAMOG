...
USING INDEX LOCAL TABLESPACE TBS_HOUR;
--=============================================================================================================--
CREATE TABLE CISCO_GGSN_SAMOG_DAY
   (  
    FECHA                                     DATE,
    EQUIPO                                    VARCHAR2(30),
    VPNNAME                                   VARCHAR2(30),
 ...
 (
 PARTITION SAMOG_GGSN_20161215  VALUES LESS THAN (TO_DATE(' 2016-12-16 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'))
 );
 
 ALTER TABLE CISCO_GGSN_SAMOG_DAY ADD CONSTRAINT CISCO_GGSN_SAMOG_DAY_PK_NEW PRIMARY KEY (FECHA, VPNID, SERVID)
USING INDEX LOCAL TABLESPACE TBS_DAY;

--=============================================================================================================--
CREATE TABLE CISCO_GGSN_SAMOG_BH
   (  
    FECHA                                     DATE,
    EQUIPO                                    VARCHAR2(30),
    VPNNAME                                   VARCHAR2(30),
 ...
 ALTER TABLE CISCO_GGSN_SAMOG_BH ADD CONSTRAINT CISCO_GGSN_SAMOG_BH_PK_NEW PRIMARY KEY (FECHA, VPNID, SERVID)
USING INDEX LOCAL TABLESPACE TBS_DAY;
--=============================================================================================================--
CREATE TABLE CISCO_GGSN_SAMOG_ISABHW
   (  
    FECHA                                     DATE,
    EQUIPO                                    VARCHAR2(30),
    VPNNAME                                   VARCHAR2(30),
  ...
  PARTITION BY RANGE (FECHA) INTERVAL (NUMTODSINTERVAL (7,'DAY'))  
 (
 PARTITION SAMOG_GGSN_20161218 VALUES LESS THAN (TO_DATE(' 2016-12-25 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'))
 );
 
 ALTER TABLE CISCO_GGSN_SAMOG_ISABHW ADD CONSTRAINT CISCO_GGSN_SAMOG_ISABHW_PK_NEW PRIMARY KEY (FECHA, VPNID, SERVID)
USING INDEX LOCAL TABLESPACE TBS_SUMMARY;
--=============================================================================================================--
CREATE TABLE CISCO_GGSN_EPDG_HOUR
   (  
    FECHA                                   DATE,
    EQUIPO                                  VARCHAR2(30),
    VPNNAME                                 VARCHAR2(30),
  ...
  PARTITION BY RANGE (FECHA) INTERVAL (NUMTODSINTERVAL (1,'HOUR'))  
 (
 PARTITION EPDG_GGSN_2016120500  VALUES LESS THAN (TO_DATE(' 2016-12-05 01:00:00', 'SYYYY-MM-DD HH24:MI:SS'))
 );
 
 ALTER TABLE CISCO_GGSN_EPDG_HOUR ADD CONSTRAINT CISCO_GGSN_EPDG_HOUR_PK PRIMARY KEY (FECHA, VPNID, SERVID)
USING INDEX LOCAL TABLESPACE TBS_HOUR;
--=============================================================================================================--
CREATE TABLE CISCO_GGSN_EPDG_BH
   (  
    FECHA                                   DATE,
    EQUIPO                                  VARCHAR2(30),
    VPNNAME                                 VARCHAR2(30),
 ...
 ALTER TABLE CISCO_GGSN_EPDG_BH ADD CONSTRAINT CISCO_GGSN_EPDG_BH_PK_NEW PRIMARY KEY (FECHA, VPNID, SERVID)
USING INDEX LOCAL TABLESPACE TBS_DAY;
--=============================================================================================================--
...
USING INDEX LOCAL TABLESPACE TBS_DAY;
--=============================================================================================================--
CREATE TABLE CISCO_GGSN_EPDG_ISABHW
   (  
    FECHA                                   DATE,
    EQUIPO                                  VARCHAR2(30),
    VPNNAME                                 VARCHAR2(30),
  ...
  PARTITION BY RANGE (FECHA) INTERVAL (NUMTODSINTERVAL (7,'DAY'))  
 (
 PARTITION EPDG_GGSN_20161218  VALUES LESS THAN (TO_DATE(' 2016-12-25 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'))
 );
 
 ALTER TABLE CISCO_GGSN_EPDG_ISABHW ADD CONSTRAINT CISCO_GGSN_EPDG_ISABHW_PK_NEW PRIMARY KEY (FECHA, VPNID, SERVID)
USING INDEX LOCAL TABLESPACE TBS_SUMMARY;
--=============================================================================================================--
      ...
      WHEN DML_ERRORS THEN
        L_ERRORS := SQL%BULK_EXCEPTIONS.COUNT;
                ...
                LOOP
                    ...
                    G_ERROR_LOG_NEW.P_LOG_ERROR('P_CISCO_GGSN_EPDG_HOUR',L_ERRNO,L_MSG,
      ...
      WHEN DML_ERRORS THEN
        L_ERRORS := SQL%BULK_EXCEPTIONS.COUNT;
                ...
                LOOP
                    ...
                    G_ERROR_LOG_NEW.P_LOG_ERROR('P_CISCO_GGSN_EPDG_DAY',L_ERRNO,L_MSG,
                    'V_BULK_ERRORS EXCEPTION FECHA: '||
                    TO_CHAR(T_ARRAY_COL(L_IDX).FECHA)||
                    ' SERVID '||TO_CHAR(T_ARRAY_COL(L_IDX).SERVID));
      ...
      -- CAPTURE EXCEPTIONS TO PERFORM OPERATIONS DML
           L_ERRORS := SQL%BULK_EXCEPTIONS.COUNT;
              ...
              LOOP
                  ...
                  G_ERROR_LOG_NEW.P_LOG_ERROR('P_CISCO_GGSN_EPDG_BH',L_ERRNO,L_MSG,
                    'V_BULK_ERRORS EXCEPTION FECHA: '||
                    TO_CHAR(T_ARRAY_COL(L_IDX).FECHA)||
                    ' SERVID '||TO_CHAR(T_ARRAY_COL(L_IDX).SERVID));
      ...
      -- CAPTURE EXCEPTIONS TO PERFORM OPERATIONS DML
           L_ERRORS := SQL%BULK_EXCEPTIONS.COUNT;
              ...
              LOOP
                  ...
                  G_ERROR_LOG_NEW.P_LOG_ERROR('P_CISCO_GGSN_EPDG_ISABHW',L_ERRNO,L_MSG,
                    'V_BULK_ERRORS EXCEPTION FECHA: '||
                    TO_CHAR(T_ARRAY_COL(L_IDX).FECHA)||
                    ' SERVID '||TO_CHAR(T_ARRAY_COL(L_IDX).SERVID));
      ...
      WHEN DML_ERRORS THEN
        L_ERRORS := SQL%BULK_EXCEPTIONS.COUNT;
                ...
                LOOP
                    ...
                    G_ERROR_LOG_NEW.P_LOG_ERROR('P_CISCO_GGSN_SAMOG_HOUR',L_ERRNO,L_MSG,
                    'V_BULK_ERRORS EXCEPTION FECHA: '||
                    TO_CHAR(T_ARRAY_COL(L_IDX).FECHA)||
                    ' SERVID '||TO_CHAR(T_ARRAY_COL(L_IDX).SERVID));
      ...
      WHEN DML_ERRORS THEN
        L_ERRORS := SQL%BULK_EXCEPTIONS.COUNT;
                ...
                LOOP
                    ...
                    G_ERROR_LOG_NEW.P_LOG_ERROR('P_CISCO_GGSN_SAMOG_DAY',L_ERRNO,L_MSG,
                    'V_BULK_ERRORS EXCEPTION FECHA: '||
                    TO_CHAR(T_ARRAY_COL(L_IDX).FECHA)||
                    ' SERVID '||TO_CHAR(T_ARRAY_COL(L_IDX).SERVID));
      ...
      -- CAPTURE EXCEPTIONS TO PERFORM OPERATIONS DML
           L_ERRORS := SQL%BULK_EXCEPTIONS.COUNT;
              ...
              LOOP
                  ...
                  G_ERROR_LOG_NEW.P_LOG_ERROR('P_CISCO_GGSN_SAMOG_BH',L_ERRNO,L_MSG,
                    'V_BULK_ERRORS EXCEPTION FECHA: '||
                    TO_CHAR(T_ARRAY_COL(L_IDX).FECHA)||
                    ' SERVID '||TO_CHAR(T_ARRAY_COL(L_IDX).SERVID));
      ...
      -- CAPTURE EXCEPTIONS TO PERFORM OPERATIONS DML
           L_ERRORS := SQL%BULK_EXCEPTIONS.COUNT;
              ...
              LOOP
                  ...
                  G_ERROR_LOG_NEW.P_LOG_ERROR('P_CISCO_GGSN_SAMOG_ISABHW',L_ERRNO,L_MSG,
                    'V_BULK_ERRORS EXCEPTION FECHA: '||
                    TO_CHAR(T_ARRAY_COL(L_IDX).FECHA)||
                    ' SERVID '||TO_CHAR(T_ARRAY_COL(L_IDX).SERVID));
...
BEGIN
  G_PARTITION_MGMT.P_TRUNCATE_PART_HOUR('CISCO_GGSN_EPDG_HOUR',P_FECHA_DESDE, P_FECHA_HASTA);
  P_CISCO_GGSN_EPDG_HOUR(P_FECHA_DESDE, P_FECHA_HASTA);
  --LANZA NIVEL DAY
...
BEGIN
  G_PARTITION_MGMT.P_TRUNCATE_PART_DAY('CISCO_GGSN_EPDG_DAY',P_FECHA_DESDE, P_FECHA_HASTA);
  P_CISCO_GGSN_EPDG_DAY(P_FECHA_DESDE, P_FECHA_HASTA);
END;
...
BEGIN
  G_PARTITION_MGMT.P_TRUNCATE_PART_DAY('CISCO_GGSN_EPDG_BH',P_FECHA_DESDE, P_FECHA_HASTA);
  P_CISCO_GGSN_EPDG_BH(P_FECHA_DESDE, P_FECHA_HASTA);
END;
...
BEGIN
  ...
  G_PARTITION_MGMT.P_TRUNCATE_PART_DAY('CISCO_GGSN_EPDG_ISABHW',P_FECHA_DESDE, P_FECHA_HASTA);
  P_CISCO_GGSN_EPDG_ISABHW(P_FECHA_DESDE, P_FECHA_HASTA);
...
BEGIN
  G_PARTITION_MGMT.P_TRUNCATE_PART_HOUR('CISCO_GGSN_SAMOG_HOUR',P_FECHA_DESDE, P_FECHA_HASTA);
  P_CISCO_GGSN_SAMOG_HOUR(P_FECHA_DESDE, P_FECHA_HASTA);
  --LANZA NIVEL DAY
...
BEGIN
  G_PARTITION_MGMT.P_TRUNCATE_PART_DAY('CISCO_GGSN_SAMOG_DAY',P_FECHA_DESDE, P_FECHA_HASTA);
  P_CISCO_GGSN_SAMOG_DAY(P_FECHA_DESDE, P_FECHA_HASTA);
END;
...
BEGIN
  G_PARTITION_MGMT.P_TRUNCATE_PART_DAY('CISCO_GGSN_SAMOG_BH',P_FECHA_DESDE, P_FECHA_HASTA);
  P_CISCO_GGSN_SAMOG_BH(P_FECHA_DESDE, P_FECHA_HASTA);
END;
...
BEGIN
  ...
  G_PARTITION_MGMT.P_TRUNCATE_PART_DAY('CISCO_GGSN_SAMOG_ISABHW',P_FECHA_DESDE, P_FECHA_HASTA);
  P_CISCO_GGSN_SAMOG_ISABHW(P_FECHA_DESDE, P_FECHA_HASTA);
